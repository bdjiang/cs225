...
class KDTree
{
  public:
    ...
    void KDTreeBuilder(int left, int right, int dimension);

    void quickSelect(int left, int right, int dimension, int medianIndex);

    int partition(int left, int right, int dimension, int medianIndex);
